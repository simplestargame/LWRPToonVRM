...
namespace UnityEditor.Rendering.LWRP
{
    ...
    class LightWeightToonSubShader : IToonSubShader
    {
        ...
        public string GetSubshader(IMasterNode masterNode, GenerationMode mode, List<string> sourceAssetDependencyPaths = null)
        {
            ...
            {
                var materialTags = ShaderGenerator.BuildMaterialTags(ToonMasterNode.surfaceType);
                ...
                var materialOptions = ShaderGenerator.GetMaterialOptions(ToonMasterNode.surfaceType, ToonMasterNode.alphaMode, ToonMasterNode.twoSided.isOn);
                subShader.AppendLines(GetShaderPassFromTemplate(
                        forwardTemplate,
                        ToonMasterNode,
                        m_ForwardPassSpecular,
                        mode,
                        materialOptions));
